...
final class PIVPaddingTests: XCTestCase {
    ...
    func testPadSHA256WithRSA() throws {
        let data = "Hello world!".data(using: .utf8)!
        do {
            let result = try PIVPadding.padData(data, keyType: .rsa(.bits1024), algorithm: .rsaSignatureMessagePKCS1v15SHA256)
    ...
    func testPadSHA1WithRSA() throws {
        let data = "Hello world!".data(using: .utf8)!
        do {
            let result = try PIVPadding.padData(data, keyType: .rsa(.bits1024), algorithm: .rsaSignatureMessagePKCS1v15SHA1)
