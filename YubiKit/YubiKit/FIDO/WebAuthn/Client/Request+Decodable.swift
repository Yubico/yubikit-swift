...
// MARK: - Supporting Types Decodable
...
/// Decodes the nested authenticatorSelection object from WebAuthn JSON.
...
/// Decodes pubKeyCredParams array elements from WebAuthn JSON.
