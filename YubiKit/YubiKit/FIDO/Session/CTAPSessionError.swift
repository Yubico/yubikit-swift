...
/// Errors that can occur during FIDO2/CTAP2 session operations.
public enum FIDO2SessionError: FIDOSessionError, SmartCardSessionError, CBORError, CTAPError, Sendable {
    ...
    case failedResponse(_ responseStatus: ResponseStatus, source: SourceLocation)
