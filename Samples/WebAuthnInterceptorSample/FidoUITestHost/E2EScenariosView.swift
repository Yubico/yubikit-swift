...
// * **Flows** — multi-step user journeys (e.g. fresh key → setup → ceremony,
//   UV miss → retry → miss → PIN fallback). Mocks evolve mid-flow via shared
//   `Box<T>` state.
// * **Short dead-enders** — one-shot paths that terminate (cancel, critical
//   error). Can't live inside a flow because they end the journey.
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 0) {
                section("Flows", Scenario.flows)
                section("Authentication", Scenario.authentication)
                section("Registration", Scenario.registration)
                section("Fatal errors", Scenario.errors)
            }
            .padding(.vertical, 8)
        }
    }
...
extension Scenario {
    ...
    static let flows: [Scenario] = [
        ...
        Scenario(
            ...
            title: "Force PIN change → complexity reject",
        ...
        Scenario(
            ...
            title: "Force PIN change → wrong current PIN",
        ...
        Scenario(
            ...
            title: "Setup recovery → transient connect fail",
    ...
    static let authentication: [Scenario] = [
        Scenario(
            id: "auth_no_pin",
        ...
        Scenario(
            ...
            title: "Cancel at PIN prompt",
            summary: "Taps Cancel on the PIN panel; sheet dismisses.",
    ...
    static let registration: [Scenario] = [
        Scenario(
    ...
    static let errors: [Scenario] = [
        ...
        Scenario(
            ...
            title: "Setup recovery → host error",
