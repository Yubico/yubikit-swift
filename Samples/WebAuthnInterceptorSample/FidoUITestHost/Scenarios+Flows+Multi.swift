// Multi-ceremony / cross-ceremony journeys: register-then-auth handoff,
// transport reconnect bridge mid-stream. These don't fit the verification
// or setup-recovery buckets — they exercise the alert window's lifecycle
// across more than one ceremony, or the `runCeremony` reconnect catch.
