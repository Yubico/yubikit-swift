...
struct SuccessPanel: View {
    ...
    /// skips it — by the time this panel appears the user has already
    /// lifted the key off the phone, so the prompt would just be noise.
    ...
    var body: some View {
        ...
        .task {
            ...
            // down view (e.g. after cleanup) doesn't still fire onDismiss.
